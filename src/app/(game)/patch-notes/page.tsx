...
export default async function PatchNotes() {
  ...
  return (
    <div className="px-8">
      ...
      <Patch patch="6.12" date="April 16, 2024">
      ...
      <Patch patch="6.05" date="January 28, 2024">
        <Note note="Added Sinnoh Megas." />
      </Patch>
      <Patch patch="6.04" date="January 27, 2024">
        <Note note="Added Hoenn Megas." />
      </Patch>
      <Patch patch="6.03" date="January 26, 2024">
        <Note note="Added Johto Megas" />
      </Patch>
      <Patch patch="6.02" date="January 25, 2024">
        <Note note="Added a new rarity: Mega!" />
        <Note note="Added Kanto Megas." />
        <Note note="Added Cherish Ball." />
      </Patch>
      <Patch patch="6.01" date="January 24, 2024">
        <Note note="Added Kalos Achievements." />
      </Patch>
      <Patch patch="6.00" date="January 23, 2024">
        <Note
      ...
      <Patch patch="5.08" date="November 11, 2023">
        <Note
      ...
      <Patch patch="5.03" date="October 3, 2023">
        <Note
      ...
      <Patch patch="5.02" date="September 29, 2023">
        <Note note="Added Unova Achievements." />
      </Patch>
      <Patch patch="5.01" date="September 28, 2023">
        <Note note="Added Female forms of Hippopotas and Hippowdon." />
      </Patch>
      <Patch patch="5.00" date="September 27, 2023">
        <Note
      ...
      <Patch patch="4.24" date="September 22, 2023">
        <Note note="Close other dropdowns on Pokédex page when opening one." />
      </Patch>
      <Patch patch="4.23" date="September 20, 2023">
        <Note note="Set maximum total yield to 1,000,000,000." />
      </Patch>
      <Patch patch="4.22" date="September 19, 2023">
        <Note
      ...
      <Patch patch="4.21" date="September 18, 2023">
        <Note note="Changed Add Trade button to be purple at night." />
      </Patch>
      <Patch patch="4.20" date="September 17, 2023">
      ...
      <Patch patch="4.16" date="August 16, 2023">
        <Note note="Added Caught filter to Pokédex page." />
      </Patch>
      <Patch patch="4.15" date="August 14, 2023">
        <Note
      ...
      <Patch patch="4.14" date="August 13, 2023">
        <Note
      ...
      <Patch patch="3.00" date="May 19, 2023">
        <Note
      ...
      <Patch patch="2.16" date="May 18, 2023">
        <Note note="Added Dive Ball." />
      </Patch>
      <Patch patch="2.15" date="May 16, 2023">
        <Note
      ...
      <Patch patch="2.14" date="May 15, 2023">
      ...
      <Patch patch="2.12" date="May 13, 2023">
        <Note note="Added balance changes:" />
      ...
      <Patch patch="2.11" date="May 11, 2023">
        <Note
      ...
      <Patch patch="2.10" date="May 11, 2023">
        <Note
      ...
      <Patch patch="2.09" date="May 10, 2023">
        <Note note="Updated colour scheme to be darker." />
      </Patch>
      <Patch patch="2.08" date="May 10, 2023">
        <Note note="Added balance changes:" />
        <div className="px-4 pt-4 text-2xl font-bold">Great Ball</div>
        <ul className="list-disc px-4">
      ...
      <Patch patch="2.07" date="May 7, 2023">
        <Note note="Added balance changes:" />
        <div className="px-4 pt-4 text-2xl font-bold">Great Ball</div>
        <ul className="list-disc px-4">
      ...
      <Patch patch="2.02" date="May 1, 2023">
        <Note note="Added balance changes:" />
      ...
      <Patch patch="2.01" date="April 28, 2023">
      ...
      <Patch patch="2.00" date="April 27, 2023">
        <Note
      ...
      <Patch patch="1.20" date="April 26, 2023">
        <Note note="Changed Master Ball price from P50,000 to P100,000." />
      </Patch>
      <Patch patch="1.19" date="April 25, 2023">
        <Note note="Added balance changes:" />
        <ul className="list-disc px-4">
          <li className="ml-4">
      ...
      <Patch patch="1.18" date="April 24, 2023">
      ...
      <Patch patch="1.14" date="April 23, 2023">
        <Note note="Added Net Ball." />
      </Patch>
      <Patch patch="1.13" date="April 23, 2023">
        <Note note="Added tutorial page." />
      </Patch>
      <Patch patch="1.12" date="April 18, 2023">
        <Note note="Added balance changes:" />
        <div className="px-4 pt-4 text-2xl font-bold">Great Ball</div>
        <ul className="list-disc px-4">
      ...
      <Patch patch="1.11" date="April 16, 2023">
        <Note
          note="Added Sidebar item highlighting when mouse hovers over a menu
                item."
        />
      </Patch>
      <Patch patch="1.10" date="April 15, 2023">
      ...
      <Patch patch="1.00" date="April 5, 2023">
        <Note
