...
export default async function PatchNotes() {
	...
	return (
		<div className="px-8">
			<h1 className="py-4 font-bold text-5xl">Patch Notes</h1>
			<Patch date="April 29, 2025" patch="9.07">
				<Note note="Fixed bug where users could go over party limit when moving pokémon out of storage." />
			</Patch>
			<Patch date="April 28, 2025" patch="9.06">
				<Note note="Fixed wrong pokémon showing up in user's storage." />
			</Patch>
			<Patch date="April 27, 2025" patch="9.05">
				<Note note="Fixed pokémon being able to be moved into full boxes." />
			</Patch>
			<Patch date="April 11, 2025" patch="9.04">
				<Note note="Fixed pokémon not being able to be moved beyond box 1 in storage." />
			</Patch>
			<Patch date="April 10, 2025" patch="9.03">
				<Note note="Added Paldea and Paradox Achievements." />
			</Patch>
			<Patch date="April 9, 2025" patch="9.02">
				<Note note="Added Paldean regional forms." />
				<Note note="Added varieties for Gimmighoul, Ogerpon and Terapagos." />
			</Patch>
			<Patch date="April 7, 2025" patch="9.01">
				<Note note="Added a new rarity: Paradox!" />
				<Note note="Added Paradox Pokémon." />
				<Note note="Added Strange Ball." />
			</Patch>
			<Patch date="April 5, 2025" patch="9.00">
				<Note
			...
			<Patch date="April 2, 2025" patch="8.14">
				<Note note="Added button to switch Pokémon between boxes." />
			</Patch>
			<Patch date="April 1, 2025" patch="8.13">
			...
			<Patch date="March 23, 2025" patch="8.12">
			...
			<Patch date="February 2, 2024" patch="8.07">
			...
			<Patch date="January 31, 2024" patch="8.06">
			...
			<Patch date="November 30, 2024" patch="8.05">
				<Note note="Added Hisui Achievements." />
			</Patch>
			<Patch date="November 26, 2024" patch="8.04">
				<Note
			...
			<Patch date="April 23, 2024" patch="7.00">
				<Note
			...
			<Patch date="October 3, 2023" patch="5.03">
				<Note
			...
			<Patch date="September 29, 2023" patch="5.02">
				<Note note="Added Unova Achievements." />
			</Patch>
			<Patch date="September 28, 2023" patch="5.01">
				<Note note="Added Female forms of Hippopotas and Hippowdon." />
			</Patch>
			<Patch date="September 27, 2023" patch="5.00">
				<Note
			...
			<Patch date="September 22, 2023" patch="4.24">
				<Note note="Close other dropdowns on Pokédex page when opening one." />
			</Patch>
			<Patch date="September 20, 2023" patch="4.23">
				<Note note="Set maximum total yield to 1,000,000,000." />
			</Patch>
			<Patch date="September 19, 2023" patch="4.22">
				<Note
			...
			<Patch date="September 18, 2023" patch="4.21">
				<Note note="Changed Add Trade button to be purple at night." />
			</Patch>
			<Patch date="September 17, 2023" patch="4.20">
			...
			<Patch date="August 16, 2023" patch="4.16">
				<Note note="Added Caught filter to Pokédex page." />
			</Patch>
			<Patch date="August 14, 2023" patch="4.15">
				<Note
			...
			<Patch date="August 13, 2023" patch="4.14">
				<Note
			...
			<Patch date="May 19, 2023" patch="3.00">
				<Note
			...
			<Patch date="May 18, 2023" patch="2.16">
				<Note note="Added Dive Ball." />
			</Patch>
			<Patch date="May 16, 2023" patch="2.15">
				<Note
			...
			<Patch date="May 15, 2023" patch="2.14">
				<Note note="Added habitat information to cards." />
			</Patch>
			<Patch date="May 14, 2023" patch="2.13">
				<p className="pt-4">
			...
			<Patch date="May 13, 2023" patch="2.12">
				<Note note="Added balance changes:" />
				<div className="px-4 pt-4 font-bold text-2xl">Great Ball</div>
				<ul className="list-disc px-4">
					<li className="ml-4">Common chance changed from 30% to 20%</li>
					<li className="ml-4">Epic chance changed from 10% to 20%</li>
				</ul>
				<div className="px-4 pt-4 font-bold text-2xl">Ultra Ball</div>
				<ul className="list-disc px-4">
			...
			<Patch date="May 11, 2023" patch="2.11">
				<Note
			...
			<Patch date="May 11, 2023" patch="2.10">
				<Note
			...
			<Patch date="May 10, 2023" patch="2.09">
				<Note note="Updated colour scheme to be darker." />
			</Patch>
			<Patch date="May 10, 2023" patch="2.08">
				<Note note="Added balance changes:" />
				<div className="px-4 pt-4 font-bold text-2xl">Great Ball</div>
				<ul className="list-disc px-4">
			...
			<Patch date="May 7, 2023" patch="2.07">
				<Note note="Added balance changes:" />
				<div className="px-4 pt-4 font-bold text-2xl">Great Ball</div>
				<ul className="list-disc px-4">
			...
			<Patch date="May 5, 2023" patch="2.06">
				<Note note="Added Pokédex filtering based on region." />
			</Patch>
			<Patch date="May 5, 2023" patch="2.05">
				<Note note="Changed Shop, Pokédex, Tutorial and Patch Notes sidebar icons." />
			</Patch>
			<Patch date="May 4, 2023" patch="2.04">
				<Note note="Added Dusk Ball." />
			</Patch>
			<Patch date="May 4, 2023" patch="2.03">
				<Note note="Added balance changes:" />
				<ul className="list-disc px-4">
					<li className="ml-4">
						Rare sell price changed from P100 to P250 (Shiny Rare sell price
						changed from P200 to P500)
					</li>
					<li className="ml-4">
						Epic sell price changed from P250 to P1,500 (Shiny Epic sell price
						changed from P500 to P3,000)
					</li>
					<li className="ml-4">
						Legendary sell price changed from P500 to P5,000 (Shiny Legendary
						sell price changed from P1,000 to P10,000)
					</li>
				</ul>
			</Patch>
			<Patch date="May 1, 2023" patch="2.02">
				<Note note="Added balance changes:" />
				<div className="px-4 pt-4 font-bold text-2xl">Poké Ball</div>
				<ul className="list-disc px-4">
					<li className="ml-4">Common chance changed from 80% to 90%</li>
					<li className="ml-4">Rare chance changed from 20% to 10%</li>
				</ul>
			</Patch>
			<Patch date="April 28, 2023" patch="2.01">
				<Note note="Modified Daily Reward amount. Daily Reward now works as follows:" />
				<ul className="list-disc px-4">
					<li className="ml-4">
						If player has total yield of less than P1,000, then they get a P25
						daily reward.
					</li>
					<li className="ml-4">
						If player has total yield of P1,000 or more and less than P10,000,
						then they get a P100 daily reward.
					</li>
					<li className="ml-4">
						If player has total yield of P10,000 or more, then they get a P1,000
						daily reward.
					</li>
				</ul>
			</Patch>
			<Patch date="April 27, 2023" patch="2.00">
				<Note
			...
			<Patch date="April 26, 2023" patch="1.20">
				<Note note="Changed Master Ball price from P50,000 to P100,000." />
			</Patch>
			<Patch date="April 25, 2023" patch="1.19">
				<Note note="Added balance changes:" />
				<ul className="list-disc px-4">
					<li className="ml-4">
						Epic yield changed from P150 to P300 (Shiny Epic yield changed from
						P300 to P600)
					</li>
					<li className="ml-4">
						Legendary yield changed from P500 to P1000 (Shiny Legendary yield
						changed from P1000 to P2000)
					</li>
				</ul>
			</Patch>
			<Patch date="April 24, 2023" patch="1.18">
			...
			<Patch date="April 24, 2023" patch="1.17">
				<Note
					note="Added ability to sort obtained Pokémon by Oldest, Newest,
                Pokédex Number, and Rarity."
				/>
			</Patch>
			<Patch date="April 24, 2023" patch="1.16">
				<Note note="Added 2000 Pokémon limit." />
			</Patch>
			<Patch date="April 23, 2023" patch="1.15">
				<Note note="Added balance changes:" />
				<ul className="list-disc px-4">
					<li className="ml-4">
						Rare yield changed from P20 to P50 (Shiny Rare yield changed from
						P40 to P100)
					</li>
					<li className="ml-4">
						Epic yield changed from P50 to P150 (Shiny Epic yield changed from
						P100 to P300)
					</li>
					<li className="ml-4">
						Legendary yield changed from P100 to P500 (Shiny Legendary yield
						changed from P200 to P1000)
					</li>
				</ul>
				<div className="px-4 pt-4 font-bold text-2xl">Ultra Ball</div>
				...
				<div className="px-4 font-bold text-2xl">Master Ball</div>
				<ul className="list-disc px-4">
					<li className="ml-4">Changed price from P100,000 to P50,000</li>
					<li className="ml-4">Common chance changed from 15% to 10%</li>
					<li className="ml-4">Legendary chance changed from 10% to 5%</li>
				</ul>
			</Patch>
			<Patch date="April 23, 2023" patch="1.14">
				<Note note="Added Net Ball." />
			</Patch>
			<Patch date="April 23, 2023" patch="1.13">
				<Note note="Added tutorial page." />
			</Patch>
			<Patch date="April 18, 2023" patch="1.12">
				<Note note="Added balance changes:" />
				<div className="px-4 pt-4 font-bold text-2xl">Great Ball</div>
				<ul className="list-disc px-4">
			...
			<Patch date="April 16, 2023" patch="1.11">
				<Note
					note="Added Sidebar item highlighting when mouse hovers over a menu
                item."
				/>
			</Patch>
			<Patch date="April 15, 2023" patch="1.10">
			...
			<Patch date="April 6, 2023" patch="1.01">
				...
				<ul className="list-disc px-4">
					...
					<li className="ml-4">Legendary chance changed from 5% to 10%</li>
				</ul>
			</Patch>
			<Patch date="April 5, 2023" patch="1.00">
				<Note
