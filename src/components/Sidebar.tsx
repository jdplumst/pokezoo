      ...
      <nav
        ...
        <div className="mt-auto">
          <a href="https://pokeapi.co/" target="_blank">
            <div className="mb-2 flex items-center hover:bg-slate-300">
              <Image
          ...
          <a href="https://github.com/jdplumst/pokezoo" target="_blank">
            <div className="mb-2 flex items-center py-2 hover:bg-slate-300">
              <GoMarkGithub
                size={30}
          ...
          <button
            ...
            } pixelated flex w-full items-center py-2 hover:bg-slate-300`}>
            <GoSignOut
              size={30}
