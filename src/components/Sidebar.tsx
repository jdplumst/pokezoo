      ...
      <nav
        ...
        <Link href="/game">
          <div
            className={`${
              page === "Game" && `bg-black`
            } mb-4 flex w-full items-center hover:bg-slate-900`}>
            <Image
        ...
        <div className="mt-auto">
          <a href="https://pokeapi.co/" target="_blank">
            <div className="mb-2 flex items-center hover:bg-slate-900">
              <Image
          ...
          <a href="https://github.com/jdplumst/pokezoo" target="_blank">
            <div className="mb-2 flex items-center py-2 hover:bg-slate-900">
              <GoMarkGithub
                size={30}
          ...
          <button
            ...
            } pixelated flex w-full items-center py-2 hover:bg-slate-900`}>
            <GoSignOut
              size={30}
