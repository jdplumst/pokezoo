        ...
        <Sidebar page="PatchNotes">
          ...
          <main className="px-8">
            ...
            <section className="pb-4">
              ...
              <p className="px-4 pt-4">Added Johto Megas.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
                6.02 (January 25, 2023)
              </h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">Added a new rarity: Mega!</p>
              <p className="px-4">Added Kanto Megas.</p>
              <p className="px-4">Added Cherish Ball.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
                6.01 (January 24, 2023)
              </h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">Added Kalos Achievements.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Added Generation information to cards.
              </p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
                5.14 (December 19, 2023)
              </h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Fixed duplicate Pokémon displaying on Game and Pokédex pages.
              </p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
                5.13 (December 9, 2023)
              </h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Added themes! Users can now go to the new Settings page to
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">Added dropdown filters to Game page.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Traded Pokémon will now be sorted based on the date they were
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">Added Region information to cards.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">5.05 (October 9, 2023)</h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Display modal after user claims their daily and nightly rewards
                to show the rewards that they claimed.
              </p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">5.04 (October 7, 2023)</h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Added Wildcards! Everytime a user claims a daily or nightly
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">Added Unova Achievements.</p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
              <h3 className="p-4 text-4xl font-bold">
                5.01 (September 28, 2023)
              </h3>
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Added Female forms of Hippopotas and Hippowdon.
              </p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
            ...
            <section className="pb-4">
              ...
              <hr className="border-black"></hr>
              <p className="px-4 pt-4">
                Close other dropdowns on Pokédex page when opening one.
              </p>
            </section>
            <hr className="border-black pb-4"></hr>
            <section className="pb-4">
