...
export const user = mysqlTable(
  "User",
  {
    ...
    claimedDaily: tinyint("claimedDaily").notNull(),
    johtoStarter: tinyint("johtoStarter").notNull(),
    claimedNightly: tinyint("claimedNightly").notNull(),
    admin: tinyint("admin").notNull(),
    hoennStarter: tinyint("hoennStarter").notNull(),
    sinnohStarter: tinyint("sinnohStarter").notNull(),
    username: varchar("username", { length: 191 }),
    instanceCount: int("instanceCount").notNull(),
    unovaStarter: tinyint("unovaStarter").notNull(),
